    ...
    while Q:
        ...
        if coreindex == CN:
            ...
            if r == 0 or r == N-1 or c == 0 or c == N-1:
                Q.append((coreindex+1, corecount + 1, totalways,copyedboard))
            else:
                ...
                for i in range(4):
                    ...
                    if can_be_connected:
                        ...
                        while 0 <= nr < N and 0 <= nc < N and newboard[nr][nc] == 0:
                            ...
                            nr, nc = nr + dy[i], nc + dx[i]
                            way += 1
                        Q.append((coreindex+1, corecount + 1, totalways + way, newboard))
                if all_cantconnect: Q.append((coreindex+1, corecount, totalways, copyedboard))
